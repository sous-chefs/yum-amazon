...
- `repo_name` - String, default: name. Repository name (name property).
- `baseurl` - String. Base URL for the repository.
- `cost` - String. Relative cost of accessing this repo.
- `description` - String, default: `'Amazon Linux 2023 repository'`. Repository description.
- `enabled` - true, false, default: `true`. Whether the repository is enabled.
...
- `gpgcheck` - true, false, default: `true`. Enable GPG signature checking.
- `gpgkey` - String, default: `'file:///etc/pki/rpm-gpg/RPM-GPG-KEY-amazon-linux-2023'`. GPG key URL.
...
- `mirrorlist` - String, default: `'https://cdn.amazonlinux.com/al2023/core/mirrors/$releasever/$basearch/mirror.list'`. Mirror list URL.
